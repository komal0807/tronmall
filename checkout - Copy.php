    ...
    <div class="appContent">
      <div class="sectionTitle3"> 
		...
		<input type="hidden" class="form-control"  id="address1" name="address1" placeholder="Address1" value="" /> 
			 ...
			 <input class="form-control bg-danger text-light" tyle="text-align: center; font-size: 70px;" type="button" id="btnsubmit" name="btnsubmit" value="Pay Now ₹ <?php echo number_format($_SESSION['finalamount'],2);?>" onclick="frmsubmit(); return true;" />
			</form>
