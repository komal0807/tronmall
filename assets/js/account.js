...
$().ready(function() {
    ...
    $(document).find('#otpform').modal('hide');
    		$.ajax({
    			type: "POST", 
    ...
    //=====================change password================================================================
	 ...
	 $("#otpsubmitForm1").on('submit',(function(e) {
    ...
    $(document).find('#otpform').modal('hide');
    		...
    		//console.log(arr);
    			...
    			$("#otpclose").click();	
    	document.getElementById('regtoast').innerHTML = ('<font size="2" style="color:#000;"> Add Account successfully!</font>');
    			$('#registertoast').modal({backdrop: 'static', keyboard: false});
                $('#registertoast').modal('show');
    			$('#mobile').attr('readonly', true);
