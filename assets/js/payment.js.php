...
e.preventDefault();		
		...
		if((!(document.getElementById('online').checked)) && (!(document.getElementById('ekpay').checked)) && (!(document.getElementById('rozorpay').checked)) ) { 
			alert("Select the Payment method! ")
		}


		else if(document.getElementById('ekpay').checked){					
					document.location = "gatewayekaypay.php?Rechammount="+userammount+"";
		}

        else if(document.getElementById('rozorpay').checked){
