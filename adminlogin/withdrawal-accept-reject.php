...
<title>DHB Royal |  Withdrawal Accept/Reject</title>
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td style="color: blue; font-size:25px;" scope="col"><i class="red_txt" style="font-size:50px;"><?php 
      $new_amt = $Result['amount']-$Result['amount']/100*5;
      echo number_format($new_amt,2);?></i></td>
    </tr>
    </tbody>
    </table>
