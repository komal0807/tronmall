...
<head>
  ...
  <title>DHB Royal | History For Sapre</title>
...
$todayshow=date('d/m/Y');
  $Query=mysqli_query($con,"select * from `tbl_result` where `createdate` between '".$startday."' and '".$endday."' and `tabtype`='sapre' order by id desc");
