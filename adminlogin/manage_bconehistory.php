...
<head>
  ...
  <title>DHB Royal | History For Bcone</title>
...
$todayshow=date('d/m/Y');
  $Query=mysqli_query($con,"select * from `tbl_result` where `createdate` between '".$startday."' and '".$endday."' and `tabtype`='bcone' order by id desc");
