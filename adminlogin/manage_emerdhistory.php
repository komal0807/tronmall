...
<head>
  ...
  <title>DHB Royal | History For Emerd</title>
...
$todayshow=date('d/m/Y');
  $Query=mysqli_query($con,"select * from `tbl_result` where `createdate` between '".$startday."' and '".$endday."' and `tabtype`='emerd' order by id desc");
