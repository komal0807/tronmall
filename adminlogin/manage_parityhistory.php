...
<head>
  ...
  <title>DHB Royal | History For Parity</title>
...
//  echo "select * from `tbl_result` where `createdate` between '".$startday."' and '".$endday."' and `tabtype`='parity' order by id desc";
  $Query=mysqli_query($con,"select * from `tbl_result` where `createdate` between '".$startday."' and '".$endday."' and `tabtype`='parity' order by id desc");
