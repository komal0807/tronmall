...
?>
 ...
 <tr>
        ...
        <td><span style="color:<?php if($parityResult['color']=='green'){echo"#1DCC70";}else if($parityResult['color']=='red'){echo"#E54D42";}else if($parityResult['color']=='red+violet'){echo"#E54D42";}else if($parityResult['color']=='green+violet'){echo"#1DCC70";}?>;"><?php echo $parityResult['result'];?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
        ...
        <div class="point red" style="background:#E54D42;"></div>
        <?php }else if($parityResult['color']=='red+violet'){?>
         <div class="point" style="background:#E54D42;"></div>&nbsp;
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <td><?php echo $parityResult['periodid'];?></td>
        <!-- <td><?php //echo $parityResult['randomprice'];?></td> -->
        <td><span style="color:<?php if($parityResult['randomcolor']=='green'){echo"#1DCC70";}else if($parityResult['randomcolor']=='red'){echo"#E54D42";}else if($parityResult['randomcolor']=='red++violet'){echo"#E54D42";}else if($parityResult['randomcolor']=='green++violet'){echo"#1DCC70";}?>;"><?php echo $parityResult['randomresult'];?></span></td>
        <td>
        <div style="display: flex;">
        <div class="spacer"></div>
 ...
 $convert=date('Y-m-d H:i',$post_date2);
	...
	?>
        ...
        <div class="point2" style="color:black"><?php echo $userResult['resultnumber'].' ';
		$tt=explode("+",$userResult['resultcolor']); echo ucwords(implode(" + ",$tt));?></div>
        </div>
        <div class="mt-1" style="display: flex;">
        <div class="point2">Select</div>
        <div class="point2" style="color:<?php if($userResult['status']=='success'){echo"#fffff";}else{echo"#fffff";}?>"><?php echo $userResult['value'];?></div>
        </div>
        <div class="mt-1" style="display: flex;">
        <div class="point2">Status</div>
        <div class="point2" style="color:<?php if($userResult['status']=='success'){echo"#1DCC70";}else{echo"#fffff";}?>;"><?php echo ucfirst($userResult['status']);?></div>
        </div>
        <div class="mt-1" style="display: flex;">
...
{?>
 ...
 $convert=date('Y-m-d H:i',$post_date2);
	...
	?>
        ...
        <div class="mt-1" style="display: flex;">
        <div class="point2">Result</div>
        <div class="point2" style="color:#fffff"><?php echo $userResult['resultnumber'].' ';
		$tt=explode("+",$userResult['resultcolor']); echo ucwords(implode(" + ",$tt));?></div>
        </div>
        <div class="mt-1" style="display: flex;">
        <div class="point2">Select</div>
