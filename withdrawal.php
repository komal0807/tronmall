...
<body>
  ...
  <div class="appHeader1">
    ...
    <div class="right">
      <a class="" href="withdrawalrecord.php" onClick="open();" style="font-size:20px;">
...
$walletbalance = $rowwall['amount'];
  ...
  <div id="appCapsule">
    <div class="appContent1">
      ...
      <p class="text-center m-2" Style="font-size:11px; color: red;">Minimmum Withdrawal is Now 330 Rs</p>

      <?php
      // include("include/connection.php");
      $sql_data=mysqli_query($con,"Select * from setting where id='1' ");
      ...
      <form action="#" id="paymentForm" method="post" class="card-body" autocomplete="off">
        ...
        <div>
          ...
          <div class="text-right mt-1">
            <a href="addupidetail.php" class="text-danger"><i class="fa fa-plus"></i> Add UPI ID</a>
          </div>
  ...
  swal.fire({
    title: "Wow!",
    text: "Withdraw Money Is Currently Off!",
    type: "success"
}).then(function() {
    window.location = "/tronmall.in/myaccount.php";
});
  </script>
  <?php endif ?>
