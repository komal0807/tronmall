...
if (isset($_GET['Rechammount'])) {
  ...
  $amount = $_POST['userammount'];*/
    ...
    $_SESSION['userRechammount'] = $_GET['Rechammount'];
...
if (isset($_POST['submitRecharge'])) {
    ...
    $amount;
    $recharge_count=mysqli_query($con, "SELECT count(*) as total from tbl_recharge where userid=$userid");
    // echo($recharge_count);
    $data=mysqli_fetch_assoc($recharge_count);   
    $countIs= $data['total'];
    if($countIs > 0)
    {
    ...
    {
        // 31-10-2022
        //$amount =   $_SESSION['userRechammount']+118;
        $amount =   $_SESSION['userRechammount'];
    }
...
<body>
    <div class="setp" id="setp-1" style="display:block">
        <div class="navbar navbar-default" style="margin-bottom: 0;position: relative">
            ...
            <span id="order_time" style="color: red;">00:00</span>
        </div>
        ...
        <div class="container-fluid highlight">
            <div style="margin: 0 auto;max-width: 520px">
                ...
                <div class="payment-model" data-model="upi">
                    ...
                    <div class="upi-info">
                        <div>
                            Pay to UPI: <br>
                            <span style="color: #ff0000" id="clipboard-text"><?php echo $selectupiresult['upi1']; ?></span>
                        </div>
                        <button class="btn-copy" onclick="copyToClipboard('#clipboard-text')" style="text-align: center;width: 60px;font-size:16px">Copy</button>
                    </div>
            ...
            <div class="box">
                <div class="text-left">
                    ...
                    <div class="img-row">
                        <img data-big-img="example1" src="assets/img/p2.png">
                        <img data-big-img="example2" src="assets/img/p1.png">
                    </div>
                    <div class="img-row">
                        <img data-big-img="example3" src="assets/img/p1.png">
                        <img data-big-img="example4" src="assets/img/p2.png">
                    </div>
                    <!--<div class="img-row">-->
...
<script>
    ...
    window.onload = function() {
        var fiveMinutes = 60 * 30,
            display = document.querySelector('#order_time');
